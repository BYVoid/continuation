...
var initialize = function () {
  ...
  commander.option('--alias-cont <aliasCont>', 'set another name for "cont" function');
  commander.option('--alias-obtain <aliasObtain>', 'set another name for "obtain" function');
  commander.option('--alias-parallel <aliasParallel>', 'set another name for "parallel" function');
...
var main = exports.main = function () {
  ...
  if (commander.aliasCont) {
    options.aliases = options.aliases || {};
    options.aliases.contName = commander.aliasCont;
  }
  if (commander.aliasObtain) {
    options.aliases = options.aliases || {};
    options.aliases.obtainName = commander.aliasObtain;
  }
  if (commander.aliasParallel) {
    options.aliases = options.aliases || {};
    options.aliases.parallelName = commander.aliasParallel;
  }
