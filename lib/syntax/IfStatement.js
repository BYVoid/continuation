...
IfStatement.prototype.transform = function (place, aliases) {
  ...
  var consequentPlace = this.consequent.transform(undefined, aliases);
  var async = (consequentPlace != this.consequent.body);

  var alternatePlace;
  if (this.alternate !== null) {
    assert(this.alternate.type === 'BlockStatement');
    alternatePlace = this.alternate.transform(undefined, aliases);
