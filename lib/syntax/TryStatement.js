...
TryStatement.prototype.transform = function (place, aliases) {
  ...
  var innerPlace = this.block.transform(undefined, aliases);
  ...
  var handlerPlace;
  if (handler) {
    handlerPlace = handler.transform(undefined, aliases);
